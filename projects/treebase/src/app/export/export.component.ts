...
export class ExportComponent {
  ...
  FIELDS = [
    ...
    'attributes-species',
    'attributes-genus-clean-en',
    'attributes-genus-clean-he',
    'attributes-age',
  ...
  HEADERS: {[key: string]: string} = {
    ...
    'attributes-species': 'מין',
    'attributes-genus-clean-en': 'שם מדעי באנגלית',
    'attributes-genus-clean-he': 'שם מדעי בעברית',
    'attributes-age': 'גיל',
